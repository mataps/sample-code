	...
	function onUploadFile(up, file) {
		...
		function uploadNextChunk() {
			...
			if (up.settings.multipart && features.multipart) {
				...
				var multipart_params = plupload.extend(args, typeof up.settings.multipart_params != 'function' ? up.settings.multipart_params : up.settings.multipart_params(file));
				// var multipart_params = plupload.extend(args, up.settings.multipart_params);
				
				// Add multipart params
				plupload.each(multipart_params, function(value, name) {
